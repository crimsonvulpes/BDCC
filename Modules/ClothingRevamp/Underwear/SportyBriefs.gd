...
func getRiggedParts(_character):
	...
	if(itemState.isDamaged()):
		return {
			"panties": "res://Modules/ClothingRevamp/Underwear/underwear_assets/SportyBriefs_dam.tscn",
		}
	if(itemState.arePantiesShiftedAside()):
		return {"panties": "res://Modules/ClothingRevamp/Underwear/underwear_assets/SportyBriefs_pulledaside.tscn"}
	
	return {
		"panties": "res://Modules/ClothingRevamp/Underwear/underwear_assets/SportyBriefs.tscn",
	}
