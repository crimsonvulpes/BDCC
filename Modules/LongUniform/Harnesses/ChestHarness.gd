...
func getDescription():
	return "A simple harness straps to the chest."
...
func getBuffs():
	return [
		...
		buff(Buff.PenisCumGenerationAfterOrgasmBuff, [5]),
		]
...
func getRiggedParts(_character):
	return {
		"harness": "res://Modules/LongUniform/Harnesses/ChestHarness/ChestHarness.tscn",
	}
