...
func getRiggedParts(_character):
	...
	if(itemState.isDamaged()):
		return {
			"bra": "res://Modules/ClothingRevamp/Underwear/underwear_assets/Bra_Lace_Damaged.tscn",
		}
	if(itemState.isBraPulledUp()):
		return {"bra": "res://Modules/ClothingRevamp/Underwear/underwear_assets/Bra_Lace_pulledaside.tscn",}
	return {
		"bra": "res://Modules/ClothingRevamp/Underwear/underwear_assets/Bra_Lace.tscn",
	}
