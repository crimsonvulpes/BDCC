...
func getRiggedParts(_character):
	...
	if(inmateType == InmateType.SexDeviant):
		...
		if(itemState.isShirtOpened() || itemState.areShortsPulledDown()):
			...
			if(itemState.isShirtOpened()):
				...
				return {"clothing": "res://Modules/ClothingRevamp/MoreUniforms_compatibility/LongUni/LongUniformL_shorts.tscn",}
		...
		if(itemState.isShirtOpened() || itemState.areShortsPulledDown()):
			...
			if(itemState.isShirtOpened()):
				...
				return {"clothing": "res://Modules/ClothingRevamp/MoreUniforms_compatibility/LongUni/LongUniformR_shorts.tscn",}
	...
	if(itemState.isShirtOpened() || itemState.areShortsPulledDown()):
		...
		if(itemState.isShirtOpened()):
			...
			return {"clothing": "res://Modules/ClothingRevamp/MoreUniforms_compatibility/LongUni/LongUniformO_shorts.tscn",}
